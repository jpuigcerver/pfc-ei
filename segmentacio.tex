...
Per tal d'utilitzar aquesta tècnica s'han d'extreure un conjunt de punts extrems locals a partir del contorn de la imatge. Aquests punts sobtenen de la següent manera.
\begin{enumerate}
